///**************
		...
		$.savebtn.addEventListener('click', function(){
		 ...
		 // Android
		if (OS_ANDROID) {
			$.adultsdetail.addEventListener('open', function() {
				if($.adultsdetail.activity) {
					var activity = $.adultsdetail.activity;
			...
			$.adultsdetail.addEventListener('android:back', function() {              
					//$.adultsdetail.close();
					$.detail.close();
					//$.adultsdetail = null;
					$.detail = null;
